    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-12 border-b border-white/10">
            ...
            <div class="lg:col-span-1">
                <img src="{{ asset('arquivos/identidade-visual/logo-y-white.png') }}"
            ...
            <div>
                ...
                <ul class="flex flex-col gap-3">
                    <li>
                        <a href="{{ route('home') }}" class="text-white/60 hover:text-white hover:pl-1 transition-all duration-300 text-sm">
                            Início
                        </a>
                    </li>
                    <li>
                        <a href="#" class="text-white/60 hover:text-white hover:pl-1 transition-all duration-300 text-sm">
                            A Consult
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('contato') }}" class="text-white/60 hover:text-white hover:pl-1 transition-all duration-300 text-sm">
                            Contato
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4">
                    <li class="flex items-start gap-3">
                        <i class="fa-solid fa-location-dot text-marca mt-1 text-sm"></i>
                        <div>
                            ...
                            <a href="https://www.google.com/maps/search/Rua+S%C3%A3o+Cristov%C3%A3o+879+Cordeiros+Itaja%C3%AD+SC"
                               ...
                               class="inline-flex items-center gap-1.5 text-marca text-xs font-bold mt-2 hover:text-marca-clara transition-colors">
                    ...
                    <li class="flex items-center gap-3">
                        <i class="fa-solid fa-phone text-marca text-sm"></i>
                        <a href="tel:+554721250281" class="text-white/60 hover:text-white transition-colors text-sm">
                            (47) 2125-0281
                        </a>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fa-solid fa-envelope text-marca text-sm"></i>
                        <a href="mailto:contato@aconsultcontabilidade.com.br" class="text-white/60 hover:text-white transition-colors text-sm break-all">
            ...
            <div>
                ...
                <p class="text-white/60 text-sm mb-4 leading-relaxed">Baixe o app e gerencie seus documentos com facilidade.</p>
                <div class="flex flex-col gap-3">
                    <a href="https://apps.apple.com/br/app/onvio-documentos/id1005121694"
                       target="_blank" rel="noopener noreferrer"
                       class="flex items-center gap-3 bg-white/10 hover:bg-white/15 rounded-xl px-4 py-3 transition-all duration-300 group">
                        <i class="fa-brands fa-apple text-2xl text-white/80 group-hover:text-white transition-colors"></i>
                        <div>
                            <span class="text-[10px] text-white/50 uppercase tracking-wider block leading-none">Disponível na</span>
                            <span class="text-sm font-bold text-white/90 group-hover:text-white transition-colors">App Store</span>
                        </div>
                    </a>
                    <a href="https://play.google.com/store/apps/details?id=com.thomsonreuters.cs.onvio.drive"
                       ...
                       class="flex items-center gap-3 bg-white/10 hover:bg-white/15 rounded-xl px-4 py-3 transition-all duration-300 group">
                        ...
                        <div>
                            <span class="text-[10px] text-white/50 uppercase tracking-wider block leading-none">Disponível na</span>
                            <span class="text-sm font-bold text-white/90 group-hover:text-white transition-colors">Google Play</span>
                        </div>
                    </a>
                </div>
                ...
                <a href="https://onvio.com.br/#/"
                   target="_blank" rel="noopener noreferrer"
                   class="mt-5 w-full flex items-center justify-center gap-2 bg-marca hover:bg-marca-escura text-white py-3 rounded-xl text-sm font-bold transition-all duration-300 hover:shadow-lg hover:shadow-marca/20">
        ...
        <div class="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-1.5">
                ...
                <span class="text-white/40 text-xs">Itajaí, Santa Catarina</span>
            </div>
        </div>
    </div>
</footer>