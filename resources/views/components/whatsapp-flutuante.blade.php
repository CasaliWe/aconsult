...
<a href="https://wa.me/554721250281?text=Ol%C3%A1%21+Bem-vindo+%C3%A0+Aconsult%21+%F0%9F%91%8B+Como+podemos+ajudar%3F"
   ...
   class="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 rounded-full text-white shadow-xl transition-all duration-300 animate-pulsar hover:animate-none hover:scale-110 group"
