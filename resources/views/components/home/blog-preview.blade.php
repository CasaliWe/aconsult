...
<section class="py-20 md:py-28 bg-white relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-14 animar-entrada">
            <div>
                <span class="text-marca text-xs font-bold uppercase tracking-widest">Blog</span>
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-black text-neutral-900 mt-3">
                    Universo <span class="text-marca">Aconsult</span>
                </h2>
                <p class="text-neutral-500 font-normal mt-3 max-w-lg">
                    Descubra informações essenciais sobre contabilidade, gestão e negócios.
                </p>
            </div>
            <a href="#"
               class="inline-flex items-center gap-2 bg-marca/10 hover:bg-marca text-marca hover:text-white px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 shrink-0 group">
                Ver todas as news
                ...
                <a href="#" class="block">
                    <div class="relative overflow-hidden rounded-2xl mb-5">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="bg-marca text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full">
                                Tributário
                            </span>
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </div>
                    <div class="flex items-center gap-3 mb-3 text-xs text-neutral-400 font-normal">
                    ...
                    <h3 class="text-lg font-black text-neutral-900 group-hover:text-marca transition-colors duration-300 mb-2 leading-snug">
                        O erro silencioso de 2026 que coloca sua empresa em risco
                    </h3>
                    <p class="text-neutral-500 text-sm font-normal leading-relaxed line-clamp-2">
                ...
                <a href="#" class="block">
                    <div class="relative overflow-hidden rounded-2xl mb-5">
                        <img src="{{ asset('arquivos/imagens-empresa/1-funcionario-concentrado-computador.jpg') }}"
                             ...
                             class="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="absolute top-4 left-4">
                            <span class="bg-marca-escura text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full">
                                Fiscal
                            </span>
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <a href="#" class="block">
                    <div class="relative overflow-hidden rounded-2xl mb-5">
                        <img src="{{ asset('arquivos/imagens-empresa/3-mulheres-em-pe.jpg') }}"
                             ...
                             class="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="absolute top-4 left-4">
                            <span class="bg-neutral-900 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full">
                                Compliance
                            </span>
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
