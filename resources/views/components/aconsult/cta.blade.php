{{-- CTA - Página A Consult --}}
<section class="relative py-28 md:py-36 overflow-hidden">
    {{-- Background parallax --}}
    <div class="absolute inset-0 bg-parallax"
         style="background-image: url('{{ asset('arquivos/imagens-empresa/3-mulheres-trabalhando-alegre.jpg') }}');"></div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-10">
            <div class="text-center md:text-left animar-entrada">
                ...
                <p class="text-white/50 font-normal text-base max-w-lg">
                    Nós somos a Aconsult! Estamos aqui para fornecer a expertise que você precisa. Fale com nossos especialistas.
                </p>
            </div>
