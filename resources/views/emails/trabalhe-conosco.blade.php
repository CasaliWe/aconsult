...
<head>
    <meta charset="UTF-8">
    <title>Nova candidatura - Aconsult</title>
</head>
            ...
            <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px; width:100%; background:#ffffff; border:1px solid #e5e7eb; border-radius:14px; overflow:hidden;">
                <tr>
                    <td style="background:#111827; padding:22px 26px;">
                        ...
                        <h1 style="margin:8px 0 0; font-size:22px; line-height:1.3; color:#ffffff; font-weight:800;">Nova candidatura recebida</h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding:24px 26px;">
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                            ...
                            <tr>
                                <td style="padding:11px 0; border-bottom:1px solid #f1f5f9; color:#6b7280; font-size:13px; font-weight:700;">Área de interesse</td>
                                <td style="padding:11px 0; border-bottom:1px solid #f1f5f9; font-size:14px; color:#111827;">{{ $vaga }}</td>
                            </tr>
                            <tr>
                                <td style="padding:11px 0; color:#6b7280; font-size:13px; font-weight:700;">LinkedIn</td>
                                <td style="padding:11px 0; font-size:14px; color:#111827;">{{ $linkedin !== '' ? $linkedin : '-' }}</td>
                            </tr>
                        </table>

                        <div style="margin-top:18px; border:1px solid #f3f4f6; background:#fafafa; border-radius:10px; padding:16px;">
                            <p style="margin:0 0 8px; font-size:12px; color:#6b7280; font-weight:700; letter-spacing:0.3px; text-transform:uppercase;">Apresentação profissional</p>
                            <p style="margin:0; font-size:14px; line-height:1.75; color:#111827; white-space:pre-line;">{{ $apresentacao }}</p>
                        </div>

                        <p style="margin:14px 0 0; font-size:12px; color:#6b7280;">Currículo anexado neste e-mail (PDF).</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding:14px 26px; background:#f9fafb; border-top:1px solid #f1f5f9;">
                        <p style="margin:0; font-size:12px; color:#9ca3af;">E-mail automático enviado pelo formulário Trabalhe Conosco do site.</p>
                    </td>
                </tr>
            </table>
        </td>
