...
@section('conteudo')
    <div style="margin-bottom: 24px;">
        <p style="font-size: 13px; color: #64748b; margin: 0;">Gerencie os vídeos reels do Instagram</p>
    </div>
    ...
    <div style="background: #fff; border-radius: 12px; border: 1px solid #e2e8f0; padding: 32px;">
        <div style="text-align: center; padding: 40px 20px;">
            ...
            <p style="font-size: 14px; color: #64748b; max-width: 420px; margin: 0 auto 16px; line-height: 1.6;">
                Esta seção permitirá gerenciar os <strong style="color: #334155;">reels do Instagram</strong> exibidos no site,
                inserindo links e controlando a ordem dos vídeos.
            </p>
